meta =
{
    ...
    name = "StackingScrapyardLicenses",

    -- Title of your mod that will be displayed to players
    title = "Stacking Scrapyard Licenses",

    -- Description of your mod that will be displayed to players
    description = "Makes the scrapyard license times stack instead of overwriting each other.",
