...
meta =
{
    ...
    name = "Alt_Click_To_Move",

    -- Title of your mod that will be displayed to players
    title = "Alt Click To Move",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Changes the order issue behavior of the map so that you have to ALT to give ships a move order.\nSimply to prevent accidental move orders of any kind.",
