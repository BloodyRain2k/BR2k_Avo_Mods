...
meta =
{
    ...
    name = "No_Captain_Exp_Lost",

    -- Title of your mod that will be displayed to players
    title = "No Captain Exp Lost",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Changes the level up handling of captains so that the exp after a level up aren't thrown away.",
